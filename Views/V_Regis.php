...
<head>
    ...
    <title>Register - Greentea Library</title>
...
<body>
    <div class="Register-box text-center">
        ...
        <form action="../Controllers/C_Register.php" method="POST" class="text-start">
            ...
            <div class="mb-3">
                <label class="form-label"><i class="fas fa-lock"></i> Buat Password</label>
            ...
            <div class="mt-3 text-center">
                <a href="V_Login.php" class="text-decoration-none small" style="color: #bbb;">Sudah punya akun?</a>
            </div>
        </form>
    </div>
